...
" Description: The colorscheme "Elise".                                        |
...
hi MoreMsg ctermbg=bg ctermfg=Red cterm=NONE guibg=bg guifg=Red gui=none
...
if has("folding")
  hi Folded ctermbg=Red ctermfg=DarkCyan cterm=NONE guibg=Gray10 guifg=#66ccff gui=none
  hi FoldColumn ctermbg=Red ctermfg=Cyan cterm=NONE guibg=Gray10 guifg=#66ccff gui=none
endif
if has("signs")
...
hi Comment ctermbg=bg ctermfg=Magenta cterm=NONE guibg=bg guifg=#ff99cc gui=none
hi link SpecialComment Comment

hi Character ctermbg=bg ctermfg=Cyan cterm=NONE guibg=bg guifg=Cyan gui=none
hi String ctermbg=bg ctermfg=Red cterm=NONE guibg=bg guifg=Red gui=none
hi Constant ctermbg=bg ctermfg=Red cterm=NONE guibg=bg  guifg=LightBlue gui=none
hi link Number Constant
hi link Float Constant
hi link Boolean Constant

hi Identifier ctermbg=bg ctermfg=Cyan cterm=NONE guibg=bg guifg=Cyan gui=none
hi Function ctermbg=bg ctermfg=Green cterm=none guibg=bg guifg=Green gui=none

hi Statement ctermbg=bg ctermfg=Yellow cterm=NONE guibg=bg guifg=#eecc00 gui=none
...
hi Type ctermbg=bg ctermfg=Green cterm=none guibg=bg guifg=#99ee00 gui=none
hi link StorageClass Type
hi link Structure Type
hi link Typedef Type

hi PreProc ctermbg=bg ctermfg=Blue cterm=NONE guibg=bg guifg=#cc99ff gui=none
hi PreCondit ctermbg=bg ctermfg=Blue cterm=NONE guibg=bg guifg=#cc66dd gui=none
hi link Include PreProc
hi link Define PreProc

hi Special ctermbg=bg ctermfg=Blue cterm=NONE guibg=bg guifg=#ff8888 gui=none
hi SpecialChar ctermbg=bg ctermfg=Magenta cterm=NONE guibg=bg guifg=#ff33ff gui=none
